...
!(function () {
  ...
  var Te = Ce(),
    Le = Ce({
      defaultModifiers: [Zt, _e, Xt, Tt]
    }),
    Se = Ce({
      defaultModifiers: [Zt, _e, Xt, Tt, ye, me, we, Ut, ve]
    }),
    je = Object.freeze({
      __proto__: null,
      afterMain: bt,
  ...
  class Ge extends M {
    ...
    _getPopperConfig(t) {
      ...
      return {
        ...e,
        ...d(this._config.popperConfig, [void 0, e])
      };
    }
    _setListeners() {
  ...
  class Ln {
    ...
    static showPopup() {
      ...
      xn.querySelector("li.is-active-li").scrollIntoView({
        block: "center"
      });
    }
    static hidePopup() {
