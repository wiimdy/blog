...
업사이드 아카데미는 한국에서 진행하는 Web3 보안 인재 양성 프로그램이다. 업비트를 만든 회사인 두나무와 Theori 의 멘토님들이 강의를 해주신다.
...
나도 예전에는 해서 뭐해라는 생각으로 적극적으로 무엇을 하진 않았지만 대학 이후로? 내가 부족하더라도 지원해서 배우는 마인드를 가지게 된거 같다.
그래서 위의 말처럼 그냥 해보고 있다. 뭐 어때...?
